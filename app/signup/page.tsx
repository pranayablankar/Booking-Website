      ...
      <div className="flex-1 relative flex items-center justify-center p-4">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-r from-teal/40 to-skyBlue/40 backdrop-blur-[2px]"></div>
        </div>
          ...
          <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-xl overflow-hidden">
            <div className="p-8">
              <div className="text-center mb-8">
                ...
                >
                  <div className="h-16 w-16 bg-teal/10 rounded-full flex items-center justify-center">
                    <PalmTree className="h-8 w-8 text-teal" />
                  </div>
                </motion.div>
                <motion.h1
                  initial={{ opacity: 0 }}
                ...
                >
                  Create an account to start your tropical journey
                </motion.p>
              </div>
              ...
              <form onSubmit={handleSubmit}>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className="bg-white/70 border-gray-200 focus:border-teal focus:ring-teal"
                        required
                      />
                    </div>
                    <div className="space-y-2">
                ...
                >
                  <Button
                    type="submit"
                    className="w-full py-6 bg-teal hover:bg-teal/90 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg"
                    disabled={isLoading}
                  >
                    {isLoading ? (
